...
Version  : 3.28.0.2
Release  : 6
URL      : https://download.gnome.org/sources/gnome-keyring/3.28/gnome-keyring-3.28.0.2.tar.xz
Source0  : https://download.gnome.org/sources/gnome-keyring/3.28/gnome-keyring-3.28.0.2.tar.xz
...
%prep
%setup -q -n gnome-keyring-3.28.0.2
...
export LANG=C
export SOURCE_DATE_EPOCH=1522196976
