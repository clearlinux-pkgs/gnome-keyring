...
Source0  : https://download.gnome.org/sources/gnome-keyring/3.36/gnome-keyring-3.36.0.tar.xz
...
%prep
%setup -q -n gnome-keyring-3.36.0
cd %{_builddir}/gnome-keyring-3.36.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1585768955
...
cp %{_builddir}/gnome-keyring-3.36.0/COPYING %{buildroot}/usr/share/package-licenses/gnome-keyring/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/gnome-keyring-3.36.0/COPYING.LIB %{buildroot}/usr/share/package-licenses/gnome-keyring/01a6b4bf79aca9b556822601186afab86e8c4fbf
%make_install
