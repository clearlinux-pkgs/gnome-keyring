...
Source0  : https://download.gnome.org/sources/gnome-keyring/46/gnome-keyring-46.2.tar.xz
...
%prep
%setup -q -n gnome-keyring-46.2
cd %{_builddir}/gnome-keyring-46.2
%patch -P 1 -p1
pushd ..
cp -a gnome-keyring-46.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721140156
