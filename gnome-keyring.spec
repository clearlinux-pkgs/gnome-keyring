...
Source0  : https://download.gnome.org/sources/gnome-keyring/3.20/gnome-keyring-3.20.1.tar.xz
...
%prep
%setup -q -n gnome-keyring-3.20.1
...
export LANG=C
export SOURCE_DATE_EPOCH=1499169420
